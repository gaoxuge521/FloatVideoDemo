 ...
 * @date 2017-6-5
 */
public class FloatingView2 extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {

    private static final String TAG = "FloatingView2";
     ...
     * @param y       悬浮窗在屏幕上的y坐标
     */
    public FloatingView2(@NonNull Context context, int x, int y) {
        super(context);
        ...
        this.mMoveDirection = FloatingView2.MOVE_DIRECTION_DEFAULT;
    ...
    public boolean onPreDraw() {
        ...
        if (this.mMoveDirection == FloatingView2.MOVE_DIRECTION_NONE) {
    ...
    private void updateViewLayout(boolean isSizeChanged) {
        ...
        // FloatingView2 size changed or device rotating
        if (isSizeChanged || oldScreenWidth != newScreenWidth || oldScreenHeight != newScreenHeight) {
            if (this.mMoveDirection == FloatingView2.MOVE_DIRECTION_DEFAULT) {
            ...
            else if (this.mMoveDirection == FloatingView2.MOVE_DIRECTION_LEFT) {
                this.mParams.x = this.mPositionLimitRect.left;
            }
            else if (this.mMoveDirection == FloatingView2.MOVE_DIRECTION_RIGHT) {
        ...
        if (withAnimation) {
            ...
            this.mMoveEdgeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mWindowManager.updateViewLayout(FloatingView2.this, mParams);
                }
            });
            ...
            if (this.mParams.x != goalPositionX || this.mParams.y != goalPositionY) {
                ...
                this.mParams.y = goalPositionY;
                this.mWindowManager.updateViewLayout(FloatingView2.this, this.mParams);
            }
        }
        this.mViewTouchX = 0;
        this.mViewTouchY = 0;
